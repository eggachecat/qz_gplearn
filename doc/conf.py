# -*- coding: utf-8 -*-
#
# YCgplearn documentation build configuration file, created by
...
latex_documents = [
  ('index', 'YCgplearn.tex', u'YCgplearn Documentation',
...
man_pages = [
    ('index', 'YCgplearn', u'YCgplearn Documentation',
     [u'Trevor Stephens'], 1)
]
...
texinfo_documents = [
  ('index', 'YCgplearn', u'YCgplearn Documentation',
   u'Trevor Stephens', 'YCgplearn', 'One line description of project.',
   'Miscellaneous'),
]
