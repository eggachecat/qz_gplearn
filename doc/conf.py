# -*- coding: utf-8 -*-
#
# qz_gplearn documentation build configuration file, created by
...
release = qz_gplearn.__version__
...
latex_documents = [
  ('index', 'qz_gplearn.tex', u'qz_gplearn Documentation',
...
man_pages = [
    ('index', 'qz_gplearn', u'qz_gplearn Documentation',
     [u'Trevor Stephens'], 1)
]
...
texinfo_documents = [
  ('index', 'qz_gplearn', u'qz_gplearn Documentation',
   u'Trevor Stephens', 'qz_gplearn', 'One line description of project.',
   'Miscellaneous'),
]
